export const site = {
  name: 'Montavia',
  tagline: 'პროექტირება, მშენებლობა და რემონტი',
  discipline: 'არქიტექტურა და ურბანიზმი',
  founded: '2011',
  description:
    'მონტავია — პროექტირება, მშენებლობა და რემონტი თბილისში. არქიტექტურული პროექტირება, სამშენებლო სამუშაოები, რეკონსტრუქცია და ინტერიერის კომპლექტაცია.',
